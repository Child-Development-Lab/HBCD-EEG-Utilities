...
output_location = 'Z:\Dropboxes\tmahesh\test outputs for new sumstats+trialmeas'; %Set to where you would like your outputs, ideally a new folder saved somewhere you remember!
age_info = ''; %Set to where you have the scans.tsv files located, may be the same as the data_path
addpath = ''; %Add your eeglab plugin path here
eeglab;
...
for subject=100:length(set_names)
